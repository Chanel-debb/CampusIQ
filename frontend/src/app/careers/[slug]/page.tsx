...
export default function CareerDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-6 text-slate-700">{career.description || "No description available."}</p>

      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Card>
          <CardBody>
            <h2 className="text-sm font-semibold text-slate-500">Salary range</h2>
        ...
        <Card>
          <CardBody>
            <h2 className="text-sm font-semibold text-slate-500">Required education</h2>
            <p className="mt-1 text-lg font-semibold text-slate-900">
      ...
      <div className="mt-8">
        <h2 className="text-lg font-semibold text-slate-900">Linked programs</h2>
        {career.programs && career.programs.length > 0 ? (
              ...
              <Link key={program.id} href={`/universities/${program.university_slug}`}>
                <Card className="h-full hover:shadow-md">
                  <CardBody>
                    ...
                    <p className="text-sm text-slate-500">{program.university_name}</p>
          ...
          <p className="mt-3 text-sm text-slate-500">No linked programs yet.</p>
        )}
      </div>
    </div>
  );
